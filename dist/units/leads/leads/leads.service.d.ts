...
export declare class LeadsService {
    ...
    constructor(repo: Repository<Leads>, userService: UsersService, roleService: RolesService, userRoleService: RoleUserService, roleDescriptionService: RolesDescriptionService, teamUserService: TeamUserService);
    ...
    getDeliveredLeadsByTeam(teamID?: string): Promise<any>;
    getDeliveredLeadsFullByLead(leadID: string): Promise<any>;
    getDeliveredLeads(): Promise<any>;
    getMyLeadStats(operatorID?: string): Promise<any>;
