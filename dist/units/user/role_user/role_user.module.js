...
RoleUserModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_roles_entity_1.UserRoles])],
        providers: [role_user_service_1.RoleUserService],
        controllers: [role_user_controller_1.UserRolesController],
